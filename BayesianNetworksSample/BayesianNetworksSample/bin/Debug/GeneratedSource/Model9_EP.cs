...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model9_EP : IGeneratedAlgorithm
	{
		#region Fields
		...
		public void Constant()
		{
			...
			this.vBernoulli57 = Bernoulli.FromLogOdds(1.3862943611198908);
		...
		public void Init_numberOfIterationsDecreased_WetGrass(bool initialise)
		{
			...
			this.Rain_use_B = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli57);
