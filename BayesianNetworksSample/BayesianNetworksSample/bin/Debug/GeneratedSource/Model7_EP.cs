...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model7_EP : IGeneratedAlgorithm
	{
		#region Fields
		...
		public void Constant()
		{
			...
			this.vBernoulli48 = Bernoulli.FromLogOdds(1.5163474893680882);
		...
		public void Init_numberOfIterationsDecreased_WetGrass(bool initialise)
		{
			...
			this.Rain_use_B = ArrayHelper.MakeUniform<Bernoulli>(this.vBernoulli48);
